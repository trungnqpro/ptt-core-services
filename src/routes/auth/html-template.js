        ...
        <table>
            <tr>
                <td colspan="1" style="background-color: rgb(17,24,64); text-align: left; padding: 5px 10px;">
                    <img src="https://i.ibb.co/BPRL6Wn/logo111.png" alt="SAPP Logo" width=85px height=40px>
                </td>
            </tr>
            <tr>
                <td style="text-align: left;">
                    <h2 style="text-align: center;">Email Verification - SAPP LMS</h2>
                    <p>Welcome to SAPP'S LMS! Verify your email to start learning.</p>
                    <p>Dear ${name}</p>
                    <p>Congratulations on successfully registering as a student in our LMS! To start learning and exploringour platform, please verify your email by clicking on the link:</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <p>Thank you for choosing SAPP LMS for your educational needs. We hope you enjoy using our platform to achieve your goals.</p>
                    <p>
                        Best regards,
                        <br>
                        SAPP Academy
  ...
  <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-spacing:0px; margin-top: 100px;;"> 
    <tbody><tr> 
     <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
      <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="border-collapse:collapse;border-spacing:0px"> 
        <tbody><tr> 
         <td align="center" style="padding:0;Margin:0"><h1 style="Margin:0;line-height:36px;font-family:roboto,'helvetica neue',helvetica,arial,sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#0f2934;text-align:center"><b>Đặt lại mật khẩu cho ứng dụng SAPP - LMS</b></h1></td> 
        </tr> 
        <tr> 
