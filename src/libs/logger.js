/**
 * @fileoverview Module hỗ trợ ghi log ra file.
 *
 * @module libs/logger
 */
...
logger.configure({
    ...
    transports: [
        new DailyRotateFile({
            filename: path.join(logPath, `${app}-%DATE%.error.log`),
        ...
        new DailyRotateFile({
            filename: path.join(logPath, `${app}-%DATE%.warn.log`),
            datePattern: 'YYYY-MM-DD',
            zippedArchive: true,
            maxSize: '20m',
            maxFiles: '14d',
        ...
        new DailyRotateFile({
            filename: path.join(logPath, `${app}-%DATE%.info.log`),
            datePattern: 'YYYY-MM-DD',
            zippedArchive: true,
            maxSize: '20m',
            maxFiles: '14d',
