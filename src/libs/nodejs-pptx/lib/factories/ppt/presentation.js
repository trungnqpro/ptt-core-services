...
class PresentationFactory {
    ...
    addSlideRefIdToGlobalList(rId) {
        ...
        const presentationContent = this.content['ppt/presentation.xml']['p:presentation']
        ...
        if (presentationContent['p:sldIdLst'] === undefined) {
            ...
            const existingNodes = PptxContentHelper.extractNodes(presentationContent)
            const masterIdLstIndex = existingNodes.findIndex(node => node.key === 'p:sldMasterIdLst')
