 ...
 */
const LeaderSchema = require('./schema-mg')
 ...
 * @returns {Array<Leader>} Mảng các tài khoản
 */
...
exports.create = async role => {
    return await LeaderSchema.create(role)
}
...
exports.getById = async id => {
    return await LeaderSchema.findOne({ _id: id }).lean()
}
...
exports.updateById = async (id, updatedFields) => {
    return await LeaderSchema.findByIdAndUpdate(id, updatedFields, {
        new: true,
    }).lean()
}
...
exports.deleteById = async id => {
    return await LeaderSchema.deleteOne({ _id: id })
}

exports.getTotalNumber = async (filter = {}) => {
    return await LeaderSchema.countDocuments(filter)
}
